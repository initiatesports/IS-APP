...
const CHECKS = [
  ...
  { file:'is-enroll.html', fn:'renderUniform', must:'renderGearSelect', why:'制服揀好→器材選購（流程內；順序:資料→制服→器材→天氣→收費）' },
  { file:'is-enroll.html', fn:'renderGearSelect', must:'renderWeather', why:'器材選購→惡劣天氣（流程內）' },
