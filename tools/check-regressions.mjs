...
const CHECKS = [
  ...
  { file:'is-enroll.html', fn:'renderGearSelect', must:'renderNotes', why:'器材選購→課程注意事項' },
  ...
  { file:'is-enroll.html', fn:'renderGearSelect', must:'renderNotes', why:'器材選購後→課程注意事項頁(安全所需)' },
