...
const CHECKS = [
  ...
  { file:'is-enroll.html', fn:'doIdentify', must:'renderPriceTable', why:'認人後→收費一覽（老闆調序 2026-08-28:登入→收費→揀課→資料）' },
  ...
  { file:'is-enroll.html', fn:'renderUniform', must:'renderWeather', why:'制服揀好→惡劣天氣（順序:資料→制服→天氣→收費→揀課→費用→器材→注意事項）' },
  { file:'is-enroll.html', fn:'renderFee', must:'renderGearSelect', why:'費用(學費)後→器材選購' },
  { file:'is-enroll.html', fn:'renderGearSelect', must:'renderFee', why:'器材選購→費用明細（老闆調序 2026-08-28:器材移到費用前）' },
  { file:'is-enroll.html', fn:'submitEnroll', must:'gearItems', why:'提交時傳器材選購 gearItems（連學費一齊付）' },
  ...
  { file:'is-enroll.html', fn:'renderFee', must:'renderNotes', why:'費用明細→課程注意事項頁(安全所需;老闆調序 2026-08-28)' },
  ...
  { file:'is-enroll.html', fn:'renderMakeupInfo', must:'renderGearSelect', why:'請假補堂頁（流程內）→器材選購（老闆調序 2026-08-28）' },
  ...
  { file:'is-enroll.html', fn:'renderHome', must:'renderGearStore', why:'首頁「器材選購」入口（獨立店：直接付款＋上課時交收）' },
  { file:'is-enroll.html', fn:'renderGearStore', must:'renderGearBuyer', why:'器材店：選購→買家資料' },
