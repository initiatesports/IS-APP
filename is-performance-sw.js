...
const CACHE = 'growth-center-v4';   // 2026-09-17 bump v3→v4：老闆部機一直食舊快取見唔到身高體重合併版(is-performance 之前冇 no-cache meta)；bump 令下次開即 purge 舊 cache（activate 刪走 !==CACHE）+ HTML 已加 no-cache meta 雙重保險
